...
#=====importing libraries===========
import os
import shutil #module to copy file
from datetime import datetime, date

DATETIME_STRING_FORMAT = "%Y-%m-%d"

# Create tasks.txt if it doesn't exist
if not os.path.exists("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/tasks.txt"):
    with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/tasks.txt", "w") as default_file:
        pass

with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/tasks.txt", 'r') as task_file:
...
if not os.path.exists("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/user.txt"):
    with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/user.txt", "w") as default_file:
        default_file.write("admin;password")

# Read in user_data
with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/user.txt", 'r') as user_file:
    ...
    if menu == 'r':
        ...
        while reg_completed == False:
            ...
            if new_password == confirm_password and new_username not in username_password:
                ...
                with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/user.txt", "w") as out_file:
                    user_data = []
        ...
        with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/tasks.txt", "w") as task_file:
            task_list_to_write = []
            for t in task_list:
                str_attrs = [
                    t['username'],
        ...
        if not os.path.exists("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/task_overview.txt"):
            with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/task_overview.txt", "w") as default_file:
        ...
        # Read in task_overview data
        # with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/task_overview.txt", 'r') as task_overview_file:
        #     task_overview_data = task_overview_file.read().split("\n")
        #     task_overview_data = [t for t in task_overview_data if t != ""]

        # # creating task overview list
        # task_overview_list = []
        # for t_str in task_overview_data:
        #     curr_t = {}

        #     # Split by semicolon and manually add each component in dict form
        #     task_components = t_str.split(";")
        #     curr_t['tasks_generated'] = task_components[0]
        #     curr_t['completed_tasks'] = task_components[1]
        #     curr_t['uncompleted_tasks' ] = task_components[2]
        #     curr_t['overdue_uncompleted'] = task_components[3]
        #     curr_t['percent_incomplete'] = task_components[4]
        #     curr_t['percent_overdue'] = task_components[5]
        ...
        # task_overview_list[0]['tasks_generated'] = task_generated
        # task_overview_list[0]['completed_tasks'] = task_completed
        # task_overview_list[0]['uncompleted_tasks' ] = task_uncompleted
        # task_overview_list[0]['overdue_uncompleted'] = overdue_uncompleted
        # task_overview_list[0]['percent_incomplete'] = percent_incomplete
        # task_overview_list[0]['percent_overdue'] = percent_overdue

        # print(task_overview_list)

        with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/task_overview.txt", 'w') as task_overview_file:
            ...
            # # destination directory to copy the file into
            # destination_directory = 'T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/task_overview.txt'

            # # shutil.copy2() method to copy the file to the destination directory
            # shutil.copy2(file_to_copy, destination_directory)

        
        # with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/task_overview.txt", 'r') as task_overview_file:
        #     overvier_data = task_overview_file.read().split("\n")
        #     overvier_data = [t for t in overvier_data if t != ""]


        # overvier_list = []
        # for t_str in overvier_data:
        #     curr_t = {}
        ...
        if not os.path.exists("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/user_overview.txt"):
            with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/user_overview.txt", "w") as default_file:
                # default_file.write("")
                pass
        ...
        for user in username_password:
            ...
            for u in user_overview:
                if u["username"] == user:
                    ...
                    print("_________________________________________________")
        # update the user_overview.txt
        with open("T17 - Capstone Project - Lists, Functions, and String Handling/capstone_project_final/user_overview.txt", 'w') as task_overview_file:
